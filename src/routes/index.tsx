...
const PROJECTS = [
  {
    title: "AI Chatbot",
    icon: Bot,
    stack: ["Python", "NLP", "Transformers", "Flask"],
    problem: "Manual customer support is slow and doesn't scale across time zones.",
    features: ["Context-aware replies", "Intent detection", "Multi-turn memory"],
    impact: "Resolved 70% of FAQs without human handoff in a pilot run.",
  },
  {
    title: "Face Recognition Attendance",
    icon: ScanFace,
    stack: ["Python", "OpenCV", "FaceNet", "SQLite"],
    problem: "Paper attendance is error-prone and easy to fake.",
    features: ["Real-time face detection", "Auto attendance log", "CSV export"],
    impact: "Cut attendance time by 90% in classroom trials.",
  },
  {
    title: "Stock Prediction with ML",
    icon: LineChart,
    stack: ["Python", "LSTM", "Keras", "yfinance"],
    problem: "Retail traders lack intuitive short-term forecasts.",
    features: ["Time-series LSTM", "Trend dashboard", "Daily auto-retrain"],
    impact: "Achieved ~89% directional accuracy on backtested data.",
  },
  {
    title: "Resume ATS Analyzer",
    icon: FileSearch,
    stack: ["Python", "NLP", "spaCy", "Streamlit"],
    problem: "Candidates fail silent ATS filters without knowing why.",
    features: ["Keyword match score", "Section audit", "JD-fit suggestions"],
    impact: "Improved match score by 35% on average for tested resumes.",
  },
  {
    title: "Fake News Detection",
    icon: Newspaper,
    stack: ["Python", "TF-IDF", "Logistic Regression", "Scikit-learn"],
    problem: "Misinformation spreads faster than human fact-checkers.",
    features: ["Text classification", "Confidence scoring", "Browser-style UI"],
    impact: "94% accuracy on the LIAR benchmark subset.",
  },
  {
    title: "Object Detection (YOLO)",
    icon: Eye,
    stack: ["Python", "YOLOv8", "OpenCV", "PyTorch"],
    problem: "Real-time monitoring needs fast, accurate object recognition.",
    features: ["Live camera inference", "Custom class training", "Bounding boxes"],
    impact: "Runs at 30+ FPS on a mid-range GPU.",
  },
  {
    title: "Personal AI Assistant",
    icon: Sparkles,
    stack: ["Python", "SpeechRecognition", "pyttsx3", "LLM API"],
    problem: "Daily tasks scatter across apps and lose focus time.",
    features: ["Voice commands", "Reminders & search", "App automation"],
    impact: "Saves ~45 minutes of context switching per day.",
  },
];
